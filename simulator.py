...
class Bot_1():
	def __init__(self):
		# self.Bot = achi_wali.TeamBT() 
		# self.Bot = main.player()
		# self.Bot = Team73_2.Team_73()
		self.Bot = team11_final.Team11()
		# self.Bot = bot.Bot()
		# self.Bot = team47.Team47()
		# self.Bot = team38.Bot()
		# self.Bot = team73_temp.Team73()
		# self.Bot = team55.Team55()
	...
	def move(self, board, old_move, flag):
		...
		cells = board.find_valid_move_cells(old_move)
		# return cells[random.randrange(len(cells))]
		return self.Bot.move(board, old_move, flag)

class Bot_2():
	def __init__(self):
		self.Bot = team73.Team73() 
...
def player_turn(game_board, old_move, obj, ply, opp, flg):
		...
		try:
			starttime = time.time()									#try to get player 1's move			
